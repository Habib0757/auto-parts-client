...
const OrderList = () => {
  ...
  const deleteOrder = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        fetch(`https://powerful-basin-54899.herokuapp.com/order/${id}`, {
          method: "DELETE",
        })
          .then((res) => res.json())
          .then((data) => {
    ...
    if (orders.length !== 0) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          fetch(`https://powerful-basin-54899.herokuapp.com/order?id=${order._id}`, {
            method: "PUT",
            headers: {
  ...
  useEffect(() => {
    fetch(`https://powerful-basin-54899.herokuapp.com/orders`)
      .then((res) => res.json())
