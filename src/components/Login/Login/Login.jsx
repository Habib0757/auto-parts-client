  ...
  return (
    <div className="bg-dark-700">
      <div className="flex items-center justify-center min-h-screen">
        <div className="max-w-lg mx-auto rounded-lg shadow-xl overflow-hidden py-10 px-20 bg-dark-700 relative z-1">
          <div
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="">
              ...
              <p className="text-red-500 text-center ">Login as admin use admin@admin.com as admin and 123456 as password.</p>
            </div>
